...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo 'ADDP Bank'; ?>
  </a>
...
<div class="container">
  ...
  <div class="card-body">
           ...
           $row2 = $array3->fetch_assoc();
            echo "<div class='alert alert-success w-50 mx-auto'>
                  <form method='POST'>
                    ...
                    Account Holder Bank Name.
                    <input type='text' class='form-control' value='ADDP Bank' readonly required>
                    Enter Amount for tranfer.
    ...
    if (isset($_POST['transfer']))
    {
      ...
      $array = $con->query("select * from transaction where userId ");
      if ($array ->num_rows > 0) 
      {
